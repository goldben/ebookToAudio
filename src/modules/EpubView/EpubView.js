...
class EpubView extends Component {
  ...
  getPlayText = () => {
    ...
    if (frame) {
      return frame.contentDocument.documentElement.innerText;
    }
  };
  ...
  render() {
    ...
    return (
      <Fragment>
        <div ref={this.container} style={styles.viewHolder}>
          {(isLoaded && this.renderBook()) || loadingView}
        </div>
        <Speak getPlayText={this.getPlayText} txt={this.state.txt} />
      </Fragment>
    );
  }
}
